...
declare module 'fastcall' {
    ...
    //     size:number;
    //     deref():number;
    //     set(h_b:Buffer, offset:number, value:number):void;
    // }

    export module ref {
    //     export function alloc(type:string|Type, value?:number|string):Type;
    //     export function refType(type:string|Type):Type;
    ...
    //         pointer: number
    //     };
    //     export const NULL_POINTER:Buffer;
