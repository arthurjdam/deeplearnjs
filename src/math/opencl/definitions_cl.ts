...
export enum cl_device_fp_config {
    CL_FP_DENORM = (1 << 0),
    CL_FP_INF_NAN = (1 << 1),
...
export enum cl_device_mem_cache_type {
    CL_NONE = 0x0,
    CL_READ_ONLY_CACHE = 0x1,
    CL_READ_WRITE_CACHE = 0x2
}

export enum cl_device_local_mem_type {
    CL_LOCAL = 0x1,
    CL_GLOBAL = 0x2
}

export enum cl_device_exec_capabilities {
    CL_EXEC_KERNEL = (1 << 0),
    CL_EXEC_NATIVE_KERNEL = (1 << 1)
}

export enum cl_command_queue_properties {
    CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE = (1 << 0),
    CL_QUEUE_PROFILING_ENABLE = (1 << 1)
}

export enum cl_context_info {
...
export enum cl_context_properties {
    CL_CONTEXT_PLATFORM = 0x1084,
    CL_CONTEXT_INTEROP_USER_SYNC = 0x1085
}

export enum cl_device_partition_property {
...
export enum cl_device_affinity_domain {
...
export enum cl_command_queue_info {
...
export enum cl_mem_object_type {
...
export enum cl_addressing_mode {
...
export enum cl_filter_mode {
    CL_FILTER_NEAREST = 0x1140,
    CL_FILTER_LINEAR = 0x1141
}

export enum cl_sampler_info {
...
export enum cl_map_flags {
    CL_MAP_READ = (1 << 0),
    CL_MAP_WRITE = (1 << 1),
    CL_MAP_WRITE_INVALIDATE_REGION = (1 << 2)
}

export enum cl_program_info {
...
export enum cl_program_build_info {
...
export enum cl_program_binary_type {
...
export enum cl_kernel_arg_info {
...
export enum cl_kernel_arg_address_qualifier {
...
export enum cl_kernel_arg_access_qualifier {
...
export enum cl_kernel_arg_type_qualifer {
...
export enum cl_kernel_work_group_info {
...
export enum command_execution_status {
    CL_COMPLETE = 0x0,
    CL_RUNNING = 0x1,
    CL_SUBMITTED = 0x2,
    CL_QUEUED = 0x3
...
export enum cl_buffer_create_type {
    CL_BUFFER_CREATE_TYPE_REGION = 0x1220
}

export enum cl_profiling_info {
